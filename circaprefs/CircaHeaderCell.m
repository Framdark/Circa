#import "CircaHeaderCell.h"
#import <UIKit/UIImage+Private.h>
#import <version.h>

static CGFloat const qHeaderCellFontSize = 30.f;

@implementation CircaHeaderCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier specifier:(PSSpecifier *)specifier {
	...
	if (self) {
		...
		UIImageView *imageView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"circaprefs_header" inBundle:[NSBundle bundleForClass:self.class]]] autorelease];
        ...
        //if ([[NSFileManager defaultManager] fileExistsAtPath:@"/var/lib/dpkg/info/org.thebigboss.circa.list"]) {
            typeLabel.text = @"";
      // }
      // else {
